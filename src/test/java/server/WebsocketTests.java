...
public class WebsocketTests {
    ...
    private static final WebSocketHandler wsHandler = new WebSocketHandler(USER_ACCESS, GAME_ACCESS, AUTH_ACCESS);
...
//        wsHandler.connect(loginResult.authToken(), roomCode, );
//    }
////
//    @Test
//    @Order(2)
